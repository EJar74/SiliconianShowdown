...
class ClientGUI:
    ...
    def onlineBattle(self):
        ...
        credit = tkinter.Label(credit_frame,text="Siliconian Showdown was created and developed by Eli Jaramillo, and does not claim to own any of the intellectual property belonging to Smith & Tinker.\n\
                               For questions, comments or concerns, you can reach me at Eli.Jaramillo74@gmail.com\nHappy Splatting!", bg="black", fg="white")
    ...
    def swarmSelection(self):
        ...
        print(mag_list,vel_list,hex_list,cust_list)
    ...
    def send_selections(self):
        ...
        print("received summary?", self.round_summary)
...
This project and all of the code behind it was developed thoroughly solely by Eli Jaramillo (I also wrote this quick guide on how to play).
